    ...
    <div className="bg-dark text-gray-300 text-sm py-2 hidden md:block">
      <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
        <div className="flex items-center gap-6">
          <a href="tel:+263777851134" className="flex items-center gap-1.5 hover:text-primary transition-colors">
            <Phone size={13} />
            <span>+263 777 851 134 | +263 773 474 208</span>
          </a>
          <a href="mailto:sales@partsgatengineering.co.zw" className="flex items-center gap-1.5 hover:text-primary transition-colors">
            <Mail size={13} />
            <span>sales@partsgatengineering.co.zw</span>
          </a>
          <span className="flex items-center gap-1.5">
            <MapPin size={13} />
            <span>Unit 32E Kenmark Cres, Bluffhill Industrial Park, Harare</span>
          </span>
        </div>
